...
class _EcranExamensAvenirState extends State<EcranExamensAvenir> {
  ...
  Future<List<ModeleExamen>> _getData() async {
    ...
    return SourceExamenDistante(token: prefs.getString('token') ?? "")
        .getListByEndpoint('examens-avenir');
  }
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: orangeExamino, width: 4),
                      ),
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(exam.titre,
                                  style: TextStyle(
                                      ...
                                      fontSize: 18,
                                      color: vertExamino)),
                              Text(exam.date, style: const TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
  ...
  Widget _row(IconData i, String t, Color c) {
    return Padding(
